...
# Returns a list of batch_size that contains a list of sentences, where each word is encoded using bert.
class ChoiDataset(Dataset):
    def __init__(self, root, train=False, folder=False,manifesto=False, folders_paths = None, bert_model = None):
