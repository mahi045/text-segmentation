...
class WikipediaDataSet(Dataset):
    def __init__(self, root, train=True, manifesto=False, folder=False, high_granularity=False, bert_model = None):
...
tokenizer = BertTokenizer.from_pretrained("bert-base-uncased"))
    ...
    def __getitem__(self, index):
        ...
        return read_wiki_file(Path(path), self.feature_extractor, ignore_list=True, remove_special_tokens=True,
